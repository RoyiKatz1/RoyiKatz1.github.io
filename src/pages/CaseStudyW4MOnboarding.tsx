				...
				<div className="section-content">
					<div className="section-text">
						<div className="section-paragraph">
							<h3>Problem</h3>
							<p>
								When new users signed up, they faced multiple
								friction points that reduced conversions and
								increased drop-offs:
							</p>
							<ol>
								<li>
								...
								<li>
									<strong>
										Lack of Trust & Motivation to Sign Up:{" "}
									</strong>
									Candidates who clicked on our job platform
									link didn’t understand why they should sign
									up, leading to low registration rates.
								</li>
							</ol>
						</div>
						<div className="section-paragraph">
						...
						<div className="section-paragraph">
							...
							<ul className="checkmark">
								<li>
									Smoother onboarding → No unnecessary logins.
								</li>
								<li>
									<strong>18% conversion rate </strong>from
									landing page to registration, far exceeding
									industry averages (5.89% according to{" "}
									<a
				...
				<div className="section-content">
					<div className="section-text">
						<div className="section-paragraph">
							<h3>Problem</h3>
							<p>
								The questionnaire is the core of WorksForMe, but
								its flow was disrupted by match popups, leading
								to drop-offs and frustration.
							</p>
							<ol>
								<li>
									<strong>
										Unnecessary Clutter in the Questionnaire
										UX:
									</strong>
									<ul>
										<li>
											While functional, the questionnaire
											had visual noise that made it feel
								...
								<li>
									...
									<ul>
										<li>
											Every time a candidate received a
											match, a popup appeared immediately,
											even in the middle of answering
											questions.
										</li>
										<li>
											This constantly pulled users away
											from the questionnaire, making it
											harder to stay focused and complete
											the process.
										</li>
										<li>
											Some candidates left the
											questionnaire early to check
											matches, which reduced completion
											rates.
										</li>
									</ul>
								</li>
						...
						<div className="section-paragraph">
							...
							<ol>
								<li>
									<strong>
										Refined Questionnaire UX for a Cleaner
										Experience:
									</strong>
									<ul className="checkmark">
										<li>
											Decluttered the UI to make answering
											feel more natural and intuitive.
										</li>
										<li>
											Minimized distractions so candidates
											could focus on answering, not on
											interface noise.
										</li>
									</ul>
								</li>
								<li>
									<strong>
										Fixing the Match Popups for a Smoother
										Flow:
									</strong>
									<ul className="checkmark">
										<li>
											Replaced immediate popups with match
											"checkpoints" between questionnaire
											pages.
										</li>
										<li>
											Instead of interrupting candidates
											after every match, we stack all
											matches from the last page together
											and display them at a natural
											stopping point—like a checkpoint in
											a game.
										</li>
										<li>
											Gave candidates two clear choices:
											<ul>
												<li>
												...
												<li>
													“Continue Answering” → To
													stay in the questionnaire
													without disruption.
												</li>
											</ul>
										</li>
						...
						<div className="section-paragraph">
							...
							<ul className="checkmark">
								...
								<li>
									A cleaner, more focused experience → Less
									cognitive load and better engagement.
								</li>
								<li>
									Less frustration → Smoother experience,
									leading to better data quality and stronger
									job matches.
								</li>
							</ul>
						</div>
